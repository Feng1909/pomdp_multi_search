...
class _NodePP:
    ...
    def print_tree(self, **options):
        ...
        # print("test: ", self, 0, "", [None], -1, options)
    ...
    def _print_tree_helper(root,
        ...
        # print("branch_positions: ", branch_positions)
        # print("preceding_positions: ", preceding_positions)
        ...
        for i, c in enumerate(sorted_by_str(root.children)):
            ...
            skip = True
            # print("marked: ", root[c].marked)
            # print("visits: ", root[c].num_visits)
            if root[c].marked:
                skip = False
