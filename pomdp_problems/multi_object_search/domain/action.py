...
MOTION_SCHEME="multi_robot"  # can be either xy or vw
STEP_SIZE=1
...
MoveEastEast = MotionAction(MotionAction.EAST_EAST, scheme=MotionAction.SCHEME_MULTI, motion_name="EastEast")
MoveEastSouth = MotionAction(MotionAction.EAST_SOUTH, scheme=MotionAction.SCHEME_MULTI, motion_name="EastSouth")
MoveEastWest = MotionAction(MotionAction.EAST_WEST, scheme=MotionAction.SCHEME_MULTI, motion_name="EastWest")
MoveEastNorth = MotionAction(MotionAction.EAST_NORTH, scheme=MotionAction.SCHEME_MULTI, motion_name="EastNorth")
MoveWestEast = MotionAction(MotionAction.WEST_EAST, scheme=MotionAction.SCHEME_MULTI, motion_name="WestEast")
MoveWestSouth = MotionAction(MotionAction.WEST_SOUTH, scheme=MotionAction.SCHEME_MULTI, motion_name="WestSouth")
MoveWestWest = MotionAction(MotionAction.WEST_WEST, scheme=MotionAction.SCHEME_MULTI, motion_name="WestWest")
MoveWestNorth = MotionAction(MotionAction.WEST_NORTH, scheme=MotionAction.SCHEME_MULTI, motion_name="WestNorth")
MoveNorthEast = MotionAction(MotionAction.NORTH_EAST, scheme=MotionAction.SCHEME_MULTI, motion_name="NorthEast")
MoveNorthSouth = MotionAction(MotionAction.NORTH_SOUTH, scheme=MotionAction.SCHEME_MULTI, motion_name="NorthSouth")
MoveNorthWest = MotionAction(MotionAction.NORTH_WEST, scheme=MotionAction.SCHEME_MULTI, motion_name="NorthWest")
MoveNorthNorth = MotionAction(MotionAction.NORTH_NORTH, scheme=MotionAction.SCHEME_MULTI, motion_name="NorthNorth")
MoveSouthEast = MotionAction(MotionAction.SOUTH_EAST, scheme=MotionAction.SCHEME_MULTI, motion_name="SouthEast")
MoveSouthSouth = MotionAction(MotionAction.SOUTH_SOUTH, scheme=MotionAction.SCHEME_MULTI, motion_name="SouthSouth")
MoveSouthWest = MotionAction(MotionAction.SOUTH_WEST, scheme=MotionAction.SCHEME_MULTI, motion_name="SouthWest")
MoveSouthNorth = MotionAction(MotionAction.SOUTH_NORTH, scheme=MotionAction.SCHEME_MULTI, motion_name="SouthNorth")
...
elif MOTION_SCHEME == "multi_robot":
    ALL_MOTION_ACTIONS = {MoveEastEast, MoveEastSouth, MoveEastWest, MoveEastNorth,
                          MoveWestEast, MoveWestSouth, MoveWestWest, MoveWestNorth,
                          MoveNorthEast, MoveNorthSouth, MoveNorthWest, MoveNorthNorth,
                          MoveSouthEast, MoveSouthSouth, MoveSouthWest, MoveSouthNorth}
else:
